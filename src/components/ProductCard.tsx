...
const ProductCard = ({
  ...
  return (
    <Link
      to={`/products/${id}`}
      className="bg-white duration-150 w-full max-w-80 border border-gray-300 hover:border-2 hover:border-amber-600 hover:-translate-y-0.5 rounded-md overflow-hidden flex flex-col max-h-72"
    >
